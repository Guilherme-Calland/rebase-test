{
    ...
    "description": "Ronda diária",
    "group": "Supervisor",
    "cardsMetadataDTO": "{\"bedStatus\":{\"graph\":[\"Alta Hospitalar\",\"Fora do Processo de Alta\",\"Alta Médica\"],\"data\":[\"Fora do Processo de Alta\",\"Alta Médica\"]},\"hospitalization\":{\"graph\":[\"Alta Médica\",\"Alta Hospitalar\",\"Liberação Assistencial\"],\"data\":[\"Alta Médica\",\"Liberação Assistencial\",\"Alta Hospitalar\"]},\"viewOfAdmissions\":{\"graph\":[\"Alta Médica\",\"Alta Hospitalar\",\"Graph 3\"],\"data\":[\"Alta Médica\",\"Fora do Processo de Alta\"]},\"serviceStatus\":{\"graph\":null,\"data\":[\"Devolução MatMed\",\"Remoção de Enxoval\",\"Em Higiene\",\"Em Manutenção\",\"Forração\"]}}",
    "processStatus": [
        {
            "important": false,
            "terminalStatus": false,
